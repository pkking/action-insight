-- Action Insight PostgreSQL Schema
-- Applied automatically by docker-entrypoint-initdb.d on first container init.
...
CREATE TABLE IF NOT EXISTS runs (
  id BIGINT PRIMARY KEY,              -- GitHub run ID (64-bit)
  ...
  -- ADR-005: workflow file/ref metadata parsed from the run path.
  workflow_file TEXT,
  workflow_ref TEXT,
  workflow_path TEXT,
...
CREATE TABLE IF NOT EXISTS jobs (
  id BIGINT PRIMARY KEY,             -- GitHub job ID (64-bit)
...
CREATE TABLE IF NOT EXISTS pr_resolution_cache (
  ...
  error_message TEXT,
  attempted_at TEXT NOT NULL DEFAULT (NOW()::TEXT),
  resolved_at TEXT,
...
-- 7b. Durable validators for recent tracked-workflow run lists
...
CREATE TABLE IF NOT EXISTS workflow_attempts (
  ...
  updated_at TEXT,
  queue_duration_seconds DOUBLE PRECISION,    -- Workflow Queue Duration
  runtime_seconds DOUBLE PRECISION,           -- Workflow Runtime
  total_duration_seconds DOUBLE PRECISION,    -- Workflow Total Duration
...
CREATE TABLE IF NOT EXISTS workflow_jobs (
  ...
  completed_at TEXT,
  html_url TEXT,
  queue_duration_seconds DOUBLE PRECISION,    -- Job Queue Duration
  runtime_seconds DOUBLE PRECISION,           -- Job Runtime
  total_duration_seconds DOUBLE PRECISION,    -- Job Total Duration
  duration_seconds DOUBLE PRECISION,          -- Compatibility alias for Job Runtime
  labels_json TEXT,
  runner_id BIGINT,
  runner_name TEXT,
  runner_group_id BIGINT,
...
CREATE TABLE IF NOT EXISTS workflow_steps (
  ...
  started_at TEXT,
  completed_at TEXT,
  duration_seconds DOUBLE PRECISION,          -- Step Runtime only (no queue/total)
